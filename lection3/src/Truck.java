public class Truck extends Vehicle implements Fuelable, Loadable, Transportable<String> {
    ...
    @Override
    public void transport(String cargoType) {
        System.out.println(getModel() + " is transporting: " + cargoType);
    }
}
